    ...
    <div className="navbar bg-blue-900 text-white h-screen p-4 flex flex-col">
      <div className="mb-8">
        <ul className="space-y-4">
          ...
          {role === 'student' && <li><Link to="/student/courses" className="text-xl hover:text-gray-300">Courses</Link></li>}
          {role === 'instructor' && <li><Link to="/instructor/courses" className="text-xl hover:text-gray-300">Manage Courses</Link></li>}
