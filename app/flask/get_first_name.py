...
import os
import numpy as np
from get_first_name_filled import get_first_name_filled

def process_first_name(file_path):
    ...
    # cropped_image = image[int(height // 1.6):height, width // 6:(width - (width // 9))]
    ...
    values = get_first_name_filled(file_path)
    filled = []
...
# process_first_name('data_images/test_2_page_5.png')
